...
for grupo in preguntas:
    ...
    preguntas_juntas += preguntas_grupo
    preguntas_juntas += preguntas_incorrectas
    preguntas_juntas += preguntas_correctas
    preguntascompletas.append(preguntas_juntas)
preguntas_juntas+="☼"
print (preguntas_juntas)